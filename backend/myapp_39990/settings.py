"""
Django settings for myapp_39990 project.
...
WSGI_APPLICATION = 'myapp_39990.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myapp_39990 API",
    "DESCRIPTION": "API documentation for myapp_39990 App",
    "VERSION": "v1",
}
